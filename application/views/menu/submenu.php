...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg">
            ...
            <a href="" class="btn btn-primary mb-2 tambahSubmenu" data-toggle="modal" data-target="#newSubMenuModal">Tambah Submenu</a>
                    ...
                    <?php foreach ($submenu as $sm) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url('menu/hapussubmenu/') . $sm['id']; ?>" class="badge badge-danger" data-id="<?= $sm['id'] ?>" data-menu="<?= $this->uri->segment(1); ?>" data-method="hapusSubmenu">hapus</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
